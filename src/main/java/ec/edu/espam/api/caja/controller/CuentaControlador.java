...
public class CuentaControlador {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Cuenta> editar(@PathVariable(value = "id") Long id, @RequestBody @Valid Cuenta cuenta) throws Exception {
        return new ResponseEntity<>(cuentaServicio.editar(id ,cuenta), HttpStatus.OK);
    }
